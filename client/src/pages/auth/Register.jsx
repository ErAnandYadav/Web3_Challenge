...
export default function Register() {
    ...
    const etherium_wallet = useRef(null)
    const email = useRef()
    ...
    async function onSubmitForm(event) {
        ...
        const data = {
            ...
            wallet_address: etherium_wallet.current.value,
    ...
    return (
        <div className='container'>
            ...
            <form onSubmit={onSubmitForm}>
                ...
                <div className="mb-3">
                    <input type="text" placeholder='0x...' autoComplete='off' className='form-control' id="etherium_wallet_address" ref={etherium_wallet} />
                </div>
                <div className="mb-3">
